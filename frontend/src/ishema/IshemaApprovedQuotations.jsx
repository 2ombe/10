...
const IshemaApprovedQuotations = () => {
  ...
  useEffect(() => {
    const fetchQuotations = async () => {
      try {
        const response = await axios.get('/api/ishema/approved', {
  ...
  return (
    <div>
      <h2>Approved Ishema Quotations</h2>
...
export default IshemaApprovedQuotations;
