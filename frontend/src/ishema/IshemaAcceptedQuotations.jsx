...
const IshemaAcceptedQuotations = () => {
  ...
  useEffect(() => {
    const fetchQuotations = async () => {
      try {
        const response = await axios.get('/api/ishema/accepted', {
  ...
  return (
    <div>
      <h2>Accepted Ishema Quotations</h2>
...
export default IshemaAcceptedQuotations;
