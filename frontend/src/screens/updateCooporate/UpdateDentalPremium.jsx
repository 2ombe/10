...
const optionTwo = {
  "56,250": { Dental: 56250, M: 11151, "M+1": 13938, "M+2": 17425, "M+3": 21781, "M+4": 27223, "M+5": 34032, "M+6": 42536, "M+7": 53174, "M+8": 66472, "M+9": 83096, "M+10": 103877 },
  "75,000": { Dental: 75000, M: 14868, "M+1": 18585, "M+2": 23231, "M+3": 29038, "M+4": 36298, "M+5": 45372, "M+6": 56715, "M+7": 70894, "M+8": 88618, "M+9": 110772, "M+10": 138465 },
  "150,000": { Dental: 150000, M: 29735, "M+1": 37169, "M+2": 46461, "M+3": 58077, "M+4": 72596, "M+5": 90745, "M+6": 113431, "M+7": 141788, "M+8": 177236, "M+9": 221545, "M+10": 276931 },
  "225,000": { Dental: 225000, M: 44603, "M+1": 55754, "M+2": 69692, "M+3": 87115, "M+4": 108894, "M+5": 136117, "M+6": 170146, "M+7": 212683, "M+8": 265853, "M+9": 332317, "M+10": 415396 },
  "300,000": { Dental: 300000, M: 59470, "M+1": 74338, "M+2": 92923, "M+3": 116153, "M+4": 145191, "M+5": 181489, "M+6": 226862, "M+7": 283577, "M+8": 354471, "M+9": 443089, "M+10": 553861 },
  "375,000": { Dental: 375000, M: 74338, "M+1": 92923, "M+2": 116153, "M+3": 145191, "M+4": 181489, "M+5": 226862, "M+6": 283577, "M+7": 354471, "M+8": 443089, "M+9": 553861, "M+10": 692327 },
  "562,500": { Dental: 562500, M: 111507, "M+1": 139384, "M+2": 174233, "M+3": 217788, "M+4": 272233, "M+5": 340290, "M+6": 425362, "M+7": 531710, "M+8": 664647, "M+9": 830820, "M+10": 1038540 }
};
...
function UpdateDental() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setdentalCategories(data.dentalCorp.dentalCategories || []);
  ...
  const calculateOverallDependenciesTotal = (dentalTotalDependencies) => {
    if (!dentalTotalDependencies) return 0;
  ...
  const premiumData = 
    dentalCategories.length > 0 && dentalCategories[0].dentalTotalDependencies
      ? calculateOverallDependenciesTotal(dentalCategories[0].dentalTotalDependencies) < 15 
        ?optionTwo  
        : optionOne
      : null;
  ...
  }, [JSON.stringify (dentalCategories.map(dentalCategory => dentalCategory.dentalDependencies))]);
  ...
  const calculateOverallTotals = () => {
    ...
    navigate(`/UpdateCooporateOptical/${corpotateId}`);
  };
