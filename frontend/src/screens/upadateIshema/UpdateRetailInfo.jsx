...
const UpdateRetailBeneficiary = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`/api/retail/single/${retailId}`, {
  ...
  const handleSubmit = (e) => {
    ...
    try {
      ...
      navigate(`/updateretailIn/${retailId}`);
    } catch (error) {
...
export default UpdateRetailBeneficiary;
