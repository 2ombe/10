...
function UpdateSme() {
  ...
  const [quotationData, setQuotationData] = useState({
    ...
    options: {
      'Bronze': {
        ...
        dentalPremium: cart.dentalOption.limit,
        opticalPremium: cart.opticalOption.limit,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.put(`/api/sme/smeQuotation/${smeId}`, quotationData, {
      ...
      <Container>
          ...
          <Card className="mb-3">
            <Card.Body>
              ...
              <Card.Text>
                <strong>Client Names:</strong> {cart.retailInfo.institutionName}
                <br />
                <strong>Client TIN:</strong> {cart.retailInfo.tin}
                <br />
