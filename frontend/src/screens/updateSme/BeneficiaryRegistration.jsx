...
const UpdateSmeBeneficiary = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`/api/sme/single/${smeId}`, {
          headers: { Authorization: `Bearer ${userInfo.token}` },
        });  

        
        const companyInfo = response.data.beneficiaryInfo
        || {};
...
export default UpdateSmeBeneficiary;
