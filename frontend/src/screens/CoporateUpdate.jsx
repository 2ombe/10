       ...
       <Card className="mb-3">
         <Card.Body>
           ...
           <Card.Text>
             ...
             <div>Total Premium Value: {outCategory.outTotalPremium.toLocaleString()}</div>
       ...
       <Card className="mb-3">
         <Card.Body>
           ...
           <Card.Text>
             ...
             <div>Total Premium Value: {dentalCategory.dentalTotalPremium.toLocaleString()}</div>
       ...
       <Card className="mb-3">
         <Card.Body>
           ...
           <Card.Text>
             ...
             <div>Total Premium Value: {opticalCategory.opticalTotalPremium.toLocaleString()}</div>
       ...
       <Card className="mb-3">
         <Card.Body>
           ...
           <Card.Text>
             ...
             <div>Total Premium Value: {category.totalPremium.toLocaleString()}</div>
           ...
           <ListGroup variant="flush">
             <ListGroup.Item>
               <Row>
                 ...
                 <Col>{cooporateCart.overallTotals.overallTotalPremium.toFixed(2).toLocaleString()} RWF</Col>
               </Row>
             </ListGroup.Item>
             <ListGroup.Item>
               <Row>
                 <Col>Total OutPatient Premium</Col>
                 <Col>{outCart.outOverallTotals.outOverallTotalPremium.toFixed(2).toLocaleString()} RWF</Col>
               </Row>
             </ListGroup.Item>
             <ListGroup.Item>
               <Row>
...
.toFixed(2).toLocaleString()} RWF</Col>
               </Row>
             </ListGroup.Item>
             <ListGroup.Item>
               <Row>
                 <Col>Total Optical</Col>
                 <Col>{optCorp.opticalOverallTotals.opticalOverallTotalPremium.toFixed(2).toLocaleString()} RWF</Col>
               </Row>
             </ListGroup.Item>
             <ListGroup.Item>
               <Row>
                 <Col>Total Maternity</Col>
                 <Col>{totalMaternity.toFixed(2).toLocaleString()} RWF</Col>
               </Row>
             </ListGroup.Item>
             <ListGroup.Item>
               <Row>
                 <Col>Total Basic Premium</Col>
                 <Col>{totalBasic.toFixed(2).toLocaleString()} RWF</Col>
               </Row>
             </ListGroup.Item>
             <ListGroup.Item>
               <Row>
                 <Col>Mutuel De Sante</Col>
                 <Col>{MutuelDeSante.toFixed(2).toLocaleString()} RWF</Col>
               </Row>
             </ListGroup.Item>
             <ListGroup.Item>
               <Row>
                 <Col>Admin Fee</Col>
                 <Col>{AdminFee.toFixed(2).toLocaleString()} RWF</Col>
               </Row>
             </ListGroup.Item>
             <ListGroup.Item>
               <Row>
                 ...
                 <Col>
                   <strong>{overAllPremiumTotal.toFixed(2).toLocaleString()} RWF</strong>
                 </Col>
               </Row>
             </ListGroup.Item>
           </ListGroup>
