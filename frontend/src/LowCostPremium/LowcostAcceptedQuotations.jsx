...
const LowcostAcceptedQuotations = () => {
  ...
  useEffect(() => {
    const fetchQuotations = async () => {
      try {
        const response = await axios.get('/api/lowcost/accepted', {
  ...
  return (
    <div>
      <h2>Accepted Lowcost Quotations</h2>
...
export default LowcostAcceptedQuotations;
