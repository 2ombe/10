...
function CooporateOpticalPerFamily(selectedCategory) {
...
const transformedOpticals = savedOpticalData?.categories?.map(category=>({
  opticalId: category.id,
      opticalLimit: category.limit,
      opticalMembers: category.members,
          ...
          <Col>
            ...
            <Form>
              <Form.Group controlId={`opticalLimitSelect-${opticalCategory.opticalId}`}>
                <Form.Label>Select Optical per family Limit</Form.Label>
...
export default CooporateOpticalPerFamily