...
const CooporateOutPatient = () => {
  ...
  const transformedCategories = savedOutData?.categories?.map(category => ({
    ...
    { outId: 1, outLimit: '', outMembers: 0, outDependencies: {}, outTotalDependencies: {},outPremiumValues:{},outTotalPremiumValues:{}, outTotalPremium: 0, outTotalPremiumM: 0,selectedCategory:"" }
  ];
