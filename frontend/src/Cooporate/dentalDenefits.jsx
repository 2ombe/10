...
const CorporateDentalBenefits = () => {
  ...
  useEffect(() => {
    const savedOptions = localStorage.getItem("selectedDentalBenefits");
    if (savedOptions) {
      setSelectedDentalOptions(JSON.parse(savedOptions));
    }
  }, []);
...
export default CorporateDentalBenefits;
