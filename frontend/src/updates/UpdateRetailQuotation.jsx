...
const UpdateRetailQuotation = () => {
  ...
  useEffect(() => {
    axios.get(`/api/retail/single/${id}`, {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.put(`/api/retail/retailQuotation/${id}`, formData, {
      headers: { Authorization: `Bearer ${userInfo.token}` }
    })
      .then(response => {
...
export default UpdateRetailQuotation;